...
namespace ProyectoCapas.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "La ciudad del usuario es obligatorio")]
            public string City { get; set; }

            [Required(ErrorMessage = "El pais del usuario es obligatorio")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //Verificamos si los roles existen, de lo contrario se crean
                    ...
                    //Obtenemos el rol seleccionado del id de los input tipo radio 

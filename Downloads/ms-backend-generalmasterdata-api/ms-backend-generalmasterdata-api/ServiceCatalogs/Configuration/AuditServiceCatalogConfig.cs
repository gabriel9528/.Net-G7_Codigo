...
{
    public class AuditServiceCatalogConfig : IEntityTypeConfiguration<AuditServiceCatalog>
    {
        public void Configure(EntityTypeBuilder<AuditServiceCatalog> builder)
        {
            builder.ToTable("auditServiceCatalogs");

...
{
    public class EditPersonFullValidator : Validator
    {
        ...
        public EditPersonFullValidator(
        ...
        public Notification Validate(EditPersonFullRequest request)
        {
            ...
            if (request.SecondIdentityDocumentTypeId != null)
            {

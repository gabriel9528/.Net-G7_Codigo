...
{
    public class AuditDoctorConfig : IEntityTypeConfiguration<AuditDoctor>
    {
        public void Configure(EntityTypeBuilder<AuditDoctor> builder)
        {
            builder.ToTable("auditDoctors");

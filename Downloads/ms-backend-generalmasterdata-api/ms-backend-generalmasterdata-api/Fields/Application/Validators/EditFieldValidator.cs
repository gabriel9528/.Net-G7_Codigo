...
{
    public class EditFieldValidator : Validator
    {
        private readonly FieldRepository _fieldRepository;
        private readonly MedicalFormRepository _medicalFormRepository;

        public EditFieldValidator(FieldRepository fieldRepository, MedicalFormRepository medicalFormRepository)
        {
            _fieldRepository = fieldRepository;
            _medicalFormRepository = medicalFormRepository;
        }

        public Notification Validate(EditFieldRequest request)
        {

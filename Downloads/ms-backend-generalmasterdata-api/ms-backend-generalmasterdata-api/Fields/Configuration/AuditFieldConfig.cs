...
{
    public class AuditFieldConfig : IEntityTypeConfiguration<AuditField>
    {
        public void Configure(EntityTypeBuilder<AuditField> builder)
        {
            builder.ToTable("auditFields");

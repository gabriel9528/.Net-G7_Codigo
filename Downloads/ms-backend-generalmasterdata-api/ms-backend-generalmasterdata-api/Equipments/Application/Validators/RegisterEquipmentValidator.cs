...
{
    public class RegisterEquipmentValidator : Validator
    {
        ...
        public RegisterEquipmentValidator(EquipmentRepository equipmentRepository, PersonRepository personRepository, MedicalAreaRepository medicalAreaRepository, SubsidiaryRepository subsidiary)
        {
        ...
        public Notification Validate(RegisterEquipmentRequest request)
        {
            ...
            Equipment? equipment = _equipmentRepository.GetbyDescription(request.Description);
            if (equipment != null)
